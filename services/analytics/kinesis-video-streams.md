...
- **[key management]** Use the default AWS-managed KMS key when independent key control isn't required — it avoids the incremental per-API KMS usage costs charged for customer managed keys used in encryption/decryption of data keys. [doc](https://aws.amazon.com/kinesis/video-streams/faqs/)

...
<!-- BUILD-COST -->
**Generation cost so far: ~21.17M tokens** (21,172,492) across 340 workflow agents · 147 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

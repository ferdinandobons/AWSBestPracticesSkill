...
<!-- BUILD-COST -->
**Generation cost so far: ~14.61M tokens** (14,606,038) across 233 workflow agents · 101 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

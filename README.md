...
<!-- BUILD-COST -->
**Generation cost so far: ~29.13M tokens** (29,127,300) across 462 workflow agents · 207 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

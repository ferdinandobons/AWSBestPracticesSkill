...
<!-- BUILD-COST -->
**Generation cost so far: ~18.67M tokens** (18,672,400) across 302 workflow agents · 128 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

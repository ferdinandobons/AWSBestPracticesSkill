...
<!-- BUILD-COST -->
**Generation cost so far: ~3.06M tokens** (3,057,755) across 51 workflow agents · 18 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

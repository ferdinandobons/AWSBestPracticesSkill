...
<!-- BUILD-COST -->
**Generation cost so far: ~23.47M tokens** (23,465,188) across 374 workflow agents · 164 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

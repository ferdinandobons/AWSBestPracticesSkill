...
<!-- BUILD-COST -->
**Generation cost so far: ~28.51M tokens** (28,505,562) across 452 workflow agents · 202 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

...
<!-- BUILD-COST -->
**Generation cost so far: ~26.92M tokens** (26,921,496) across 426 workflow agents · 189 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

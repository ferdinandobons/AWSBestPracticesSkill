...
<!-- BUILD-COST -->
**Generation cost so far: ~6.98M tokens** (6,979,921) across 115 workflow agents · 42 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

...
<!-- BUILD-COST -->
**Generation cost so far: ~30.43M tokens** (30,430,964) across 480 workflow agents · 216 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

...
<!-- BUILD-COST -->
**Generation cost so far: ~22.54M tokens** (22,536,329) across 360 workflow agents · 157 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

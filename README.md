...
<!-- BUILD-COST -->
**Generation cost so far: ~1.81M tokens** (1,814,728) across 31 workflow agents · 11 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

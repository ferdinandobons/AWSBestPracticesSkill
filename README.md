...
<!-- BUILD-COST -->
**Generation cost so far: ~26.32M tokens** (26,321,036) across 418 workflow agents · 185 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

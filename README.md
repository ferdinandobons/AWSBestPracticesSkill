...
<!-- BUILD-COST -->
**Generation cost so far: ~25.29M tokens** (25,290,535) across 402 workflow agents · 178 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

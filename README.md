...
<!-- BUILD-COST -->
**Generation cost so far: ~24.09M tokens** (24,093,965) across 384 workflow agents · 169 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->

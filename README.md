...
<!-- BUILD-COST -->
**Generation cost so far: ~11.97M tokens** (11,972,184) across 193 workflow agents · 81 files. See [`docs/build-cost.md`](docs/build-cost.md) for the per-phase breakdown.
<!-- /BUILD-COST -->
